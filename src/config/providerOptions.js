...
export const PROVIDER_OPTIONS = [
  { value: 'auto',       label: 'Auto',       desc: 'Best available (Cerebras -> Groq -> Phi3 -> OpenRouter)' },
  ...
  { value: 'openrouter', label: 'OpenRouter', desc: 'Cloud - free-tier models (currently rate-limited often)' },
];
